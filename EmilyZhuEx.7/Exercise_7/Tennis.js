//When I was doing this, the count and movement of the tennis ball weren't quite synced and thus the count had to go up by 20 each time for it to work properly
//however, I the speed of the tennis ball is really slow and if I were to go back to it now, I would speed everything up 
function Tennis() {
  this.roll = function() {
    textSize(20);
    //var ms = millis();
