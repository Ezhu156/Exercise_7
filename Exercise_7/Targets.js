//after working with mousePressed on my project, I now have a better understanding of boolean expressions and realized I could have 
//done this using boolean expressions so that it would have been more of the way I originally planned
function Targets() {
  this.hit = function() {
      if (value === 0) {
        //target 1
        ...
        //text("2", 635, 310);
        //target 3
        image(target, 175 - (target.width / 2), 350 - (target.height / 2));
        //text("3", 160, 310);
        //target 4
        image(target, 880 - (target.width / 2), 485 - (target.height / 2));
        //text("4", 920, 500);
        //target 5
        image(target, 50 - (target.width / 2), 585 - (target.height / 2));
        //text("5", 90, 583);
        //target6
        image(target, 468 - (target.width / 2), 720 - (target.height / 2));
        //text("6", 455, 685);
